        ...
        <div className="w-full max-w-md">
          <Card className="shadow-xl border-emerald-100">
            <CardContent className="p-8 text-center">
              ...
              <h2 className="text-2xl font-bold text-emerald-900 mb-2" style={{ fontFamily: 'Nunito' }}>
                Passwort geändert!
              </h2>
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="shadow-xl border-emerald-100">
            <CardHeader className="space-y-1 pb-6">
              <CardTitle className="text-2xl font-bold text-center text-emerald-900" style={{ fontFamily: 'Nunito' }}>
                Neues Passwort
              </CardTitle>
            ...
            <CardContent>
              <form onSubmit={handleConfirmReset} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="newPassword" className="text-emerald-900">Neues Passwort</Label>
        ...
        <Card className="shadow-xl border-emerald-100">
          ...
          <CardContent>
            ...
            <div className="mt-6 text-center">
              <Link to="/login" className="text-emerald-600 hover:text-emerald-700 font-medium text-sm flex items-center justify-center gap-2">
